...
#include <cugraph/aai/target_gpu.hpp>
...
INSTANTIATE_TEST_SUITE_P(
  ...
  ::testing::Combine(
    ::testing::Values(BetweennessCentrality_Usecase{100, false, false, false, false, false},
                      BetweennessCentrality_Usecase{100, false, false, false, true, false},
                      BetweennessCentrality_Usecase{100, false, false, true, false, false},
                      BetweennessCentrality_Usecase{100, false, false, true, true, false}),
