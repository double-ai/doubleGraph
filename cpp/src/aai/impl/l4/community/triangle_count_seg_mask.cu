...
void triangle_count_seg_mask(const graph32_t& graph,
    ...
    int32_t* d_all_counts = need_all_counts ? cache.all_counts : counts;
    ...
    {
        size_t scan_bytes = cache.scan_temp_cap;
