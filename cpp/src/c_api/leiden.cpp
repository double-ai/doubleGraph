  ...
  void operator()()
  {
    if constexpr (!cugraph::is_candidate<vertex_t, edge_t, weight_t>::value) {
      ...
      CUGRAPH_EXPECTS(number_map != nullptr,
                      "number_map is required for Leiden (graph must be renumbered)");
...
{
  leiden_functor functor(handle, rng_state, graph, max_level, resolution, theta, do_expensive_check);
