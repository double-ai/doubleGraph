...
struct minimum_spanning_tree_functor : public cugraph::c_api::abstract_functor {
  ...
  void operator()()
  {
    if constexpr (!cugraph::is_candidate<vertex_t, edge_t, weight_t>::value) {
      ...
      // MST requires renumbered graphs for vertex unrenumbering
      CUGRAPH_EXPECTS(number_map != nullptr, "MST requires a renumbered graph");
      ...
      // Sync stream before calling MST (routes to AAI which uses default stream)
      handle_.sync_stream();
