...
def test_all_pairs_cosine():
    ...
    cosine_results = cosine_results.sort_values(["first", "second"]).reset_index(drop=True)
    all_pairs_cosine_results = all_pairs_cosine_results.sort_values(["first", "second"]).reset_index(drop=True)
